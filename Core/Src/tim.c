...
void MX_TIM11_Init(void)
{
  ...
  htim11.Init.Period = ((100 * SPEED_PERIOD)-1);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE9     ------> TIM1_CH1
    */
    GPIO_InitStruct.Pin = AXE_X_PULSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(AXE_X_PULSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = AXE_Z_PULSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(AXE_Z_PULSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA0/WKUP     ------> TIM5_CH1
    */
    GPIO_InitStruct.Pin = AXE_A_PULSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(AXE_A_PULSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC6     ------> TIM8_CH1
    */
    GPIO_InitStruct.Pin = AXE_Y_PULSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(AXE_Y_PULSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM10_MspPostInit 0 */
    ...
    PB8     ------> TIM10_CH1
    */
    GPIO_InitStruct.Pin = SPINDLE_PULSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM10;
    HAL_GPIO_Init(SPINDLE_PULSE_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB14     ------> TIM12_CH1
    */
    GPIO_InitStruct.Pin = AXE_B_PULSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF9_TIM12;
    HAL_GPIO_Init(AXE_B_PULSE_GPIO_Port, &GPIO_InitStruct);
